...
const cvFormatter = (arr) => {
    ...
    ////////////
   // const [{firstName,lastName,yearsOfExperience,tech}] =arr
   ...
   // const arr2 = [];
     ...
     //{
      ...
      //  arr2.push({
      //      fullName: arr[i].firstName + ' ' + lastName,
     // tech:tech
      //  });
  ...
  //  var fullName;
  //  for (let index = 0; index < arr.length-1; index++) {
  //      arr[index].fullName =`${arr[index].firstName} ${arr[index].lastName}`
   // arr.push(fullName); arr.pop(firstName); arr.pop(lastName);
  //}
