...
const LastWord = (str) => {
    ...
    let str1=str.slice(str.lastIndexOf(' ') + 1);
...
const replaceWords = (str) => {
    ...
    for(let i=0 ;  i<=str1.length;i++){
        if(str1[i] == "I")  str1.splice(str1.indexOf('I'),1,"We");
        else if(str1[i] == "am") str1.splice(str1.indexOf('am'),1,"are")
        else if(str1[i] == "was") str1.splice(str1.indexOf('was'),1,"were")
    }
