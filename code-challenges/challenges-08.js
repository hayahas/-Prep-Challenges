...
const customerAndAge = (obj) => {
  ...
  for (var customerName in obj) {
    var customerString = `Customer Name :${customerName} , Age :${obj[customerName]}`;
    customerDetails.push(customerString);
  }
